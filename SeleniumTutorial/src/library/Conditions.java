...
public class Conditions {
	...
	public static void dayOfTheWeek(int dayNumber){
		...
		case 2: 
			...
			System.out.println("Today is weird!");
			break;
		case 3: 
			System.out.println("The name of the week is Tuesday");
			break;
		case 4: 
		...
		case 7: 
			...
			break;
		default:
			System.out.println("The name of the week does not exist! Please enter valid number of the day of the week");
			break;
		}
