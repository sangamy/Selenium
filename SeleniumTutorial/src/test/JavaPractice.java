...
public class JavaPractice {
	...
	public static void main(String[] args) {// Does not return, Accepts args
		...
		Constructors excon = new Constructors(3,"xyz", 25.639);
	...
	/*	excon.setAge(30);
		...
		Constructors excon1 =new Constructors(4,"name1", 1000.00);//Person1
		Constructors excon2 =new Constructors(5,"name2", 2000.00);//Person2
	
		
		// Real time usage of Param constructor and getters
		Constructors excon3 =new Constructors(6,"name3", 3000.00);//Person3
